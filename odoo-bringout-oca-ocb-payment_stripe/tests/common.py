...
class StripeCommon(PaymentCommon):
    ...
    def setUpClass(cls):
        ...
        cls.stripe = cls._prepare_provider('stripe', update_values={
            'stripe_secret_key': 'dummy_secret_key_for_tests',
            'stripe_publishable_key': 'dummy_publishable_key_for_tests',
            'stripe_webhook_secret': 'dummy_webhook_secret_for_tests',
